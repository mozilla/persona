...
function display_saved_ids(){var a={};window.localStorage.emails&&(a=JSON.parse(window.localStorage.emails)),$("#cancellink").click(function(){confirm("Are you sure you want to cancel your account?")&&$.post("/wsapi/account_cancel",{},function(a){window.localStorage.emails=null,document.location="/"})}),$("#emailList").empty(),_(a).each(function(a,b){var c=$("<div>").addClass("emailblock"),d=$("<div>").addClass("email").text(b),e=$("<div>").addClass("meta"),f=$("<div class='keyblock'>").text(a.pub);f.hide();var g=$("<div>"),h=$("<a>").text("[show public key]");h.click(function(){f.show()}),g.append(h);var i=$("<button>").text("Forget this Email");e.append(i),i.click(function(){var a=JSON.parse(window.localStorage.emails);$.post("/wsapi/remove_email",{email:b},function(c){delete a[b],window.localStorage.emails=JSON.stringify(a),display_saved_ids()})});var j=new Date(a.created),k=$("<div class='date'>").text("Signed in at "+j.getHours()+":"+j.getMinutes()+":"+j.getSeconds()+", "+j.getMonth()+"/"+j.getDay()+"/"+j.getUTCFullYear());e.append(k),e.append(g),c.append(d),c.append(e),c.append(f),$("#emailList").append(c)})}$(function(){$("#emailList")&&display_saved_ids()})