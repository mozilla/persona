...
CefLogger = require('./transports/cef'),
HekaLogger = require('./transports/heka'),
RabbitLogger = require('./transports/rabbit'),
...
exports.logger.add(CefLogger, {});
/*exports.logger.add(HekaLogger, {});*/
/*exports.logger.add(RabbitLogger, {});*/
