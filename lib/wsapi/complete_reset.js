  ...
  db.authForVerificationSecret(req.params.token, function(err, hash, existing_user, staged_password) {
    ...
    if (staged_password) {
      ...
      // is a password provided?
        ...
        return httputils.authRequired(res, 'Provide your password- params were: ' + JSON.stringify(req.params) );
      }
    } else {
      ...
      if (typeof req.params.pass === 'string') {
        ...
        return httputils.authRequired(res, 'Provide your password' + JSON.stringify(req.params));
      }
    }
  });
