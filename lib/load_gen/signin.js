...
exports.startFunc = function(cfg, cb) {
  ...
  wcli.get(cfg, '/wsapi/session_context', context, undefined, function (r) {
    ...
    // extract server time to use it in the assertion and validate the
    // server response in one fell swoop
    try {
      serverTime = JSON.parse(r.body).server_time;
      if (!serverTime) throw "bogus";
